...
const COMPACT_NUMERIC_HORIZONTAL_OFFSET = -0.05;
...
export function drawManaSymbol(
    ...
    let horizontalOffset = COMPACT_NUMERIC_HORIZONTAL_OFFSET;
    if (secondDigit === "1") {
        // narrower for "1" as second digit.
        horizontalOffset *= 0.2;
    }

    const compactX = (symbolWidth - compactWidth) / 2 + (size * horizontalOffset);
